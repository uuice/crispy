...
/**
 * Renders Payload media with Next/Image.
 * Prefers persisted `sizes.*` (OSS process URLs); absolute URLs skip `/_next/image`.
 */
export const ImageMedia: React.FC<MediaProps> = (props) => {
  ...
  if (!src && resource && typeof resource === 'object') {
    ...
    const resolved = resolveMediaImageSrc(resource, { variant: imageVariant })
    src = resolved.src
  ...
  const quality =
    imageVariant === 'thumbnail' || imageVariant === 'small' || imageVariant === 'square' ? 75 : 85
