...
export const CUSTOM_ADMIN_NAV_ITEMS: CustomAdminNavItem[] = [
  ...
  { path: '/cache', label: '缓存管理', group: adminLabels.systemGroup },
  { path: '/api-docs', label: 'Swagger API', group: adminLabels.systemGroup },
  { path: '/dev-docs', label: '二次开发文档', group: adminLabels.systemGroup },
]
