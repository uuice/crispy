...
export const createAdItem = async (
  ...
  try {
    const adItem = await adItemService.createAdItem(req.body)
...
export const updateAdItem = async (
  ...
  try {
    ...
    const adItem = await adItemService.updateAdItem(id, req.body)
...
export const deleteAdItem = async (
  ...
  try {
    ...
    await adItemService.deleteAdItem(id)
