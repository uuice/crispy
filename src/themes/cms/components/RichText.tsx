...
function createRichTextConverters(headings: LexicalHeading[]): JSXConvertersFunction<NodeTypes> {
  let headingIndex = 0
...
export function CmsRichText({ className, data, enableGutter = false, headings = [], ...rest }: Props) {
  return (
    <ConvertRichText
      converters={createRichTextConverters(headings)}
      className={cn(
