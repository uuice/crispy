...
export function ArticleCopyright({ articleUrl, publishDate }: Props) {
  ...
  return (
    <div className="kb-article-copyright">
      <div className="kb-article-copyright-box">
        <p className="kb-article-copyright-label">版权信息</p>
        <div className="kb-article-copyright-row">
          <span>链接</span>
