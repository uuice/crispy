    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ...
          [
            'pnpm cli util:repair-authz|sync-oss-sizes|test-oss|…',
            '运维脚本（authz / OSS / versions / 空库 seed）；pnpm cli help util',
          ],
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          '若 Collection/Global/Block 字段有变：pnpm cli db:create <name> → 审阅 src/migrations/ → pnpm cli db:migrate（需 Postgres）',
          'pnpm cli quality:ci',
          '手工冒烟（见下方 Checklist）',
