...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_frontend_cache_entries_kind" AS ENUM('data', 'route');
  ...
  CREATE TABLE "frontend_cache_entries_tags" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "frontend_cache_entries" (
  	...
  	"kind" "enum_frontend_cache_entries_kind" DEFAULT 'data' NOT NULL,
  	"route_path" varchar,
  	"cached_value" jsonb,
  ...
  CREATE TABLE "cache_settings" (
  	...
  	"data_cache_revalidate_seconds" numeric DEFAULT 600,
  ...
  ALTER TABLE "frontend_cache_entries_tags" ADD CONSTRAINT "frontend_cache_entries_tags_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."frontend_cache_entries"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "frontend_cache_entries_tags_order_idx" ON "frontend_cache_entries_tags" USING btree ("_order");
  CREATE INDEX "frontend_cache_entries_tags_parent_id_idx" ON "frontend_cache_entries_tags" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "frontend_cache_entries_tags" CASCADE;
