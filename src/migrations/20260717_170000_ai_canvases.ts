...
/**
 * P3 MVP: ai-canvases (per-user, multi-canvas) + locked-docs / MCP / query-preset.
 */
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    ...
    ALTER TYPE "public"."enum_payload_query_presets_related_collection" ADD VALUE IF NOT EXISTS 'ai-canvases';
