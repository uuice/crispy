...
CREATE TABLE IF NOT EXISTS `articles` (
  ...
  `is_review` tinyint(2) NOT NULL DEFAULT 0 COMMENT '是否需要审核 1需要 0不需要',
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `is_super_admin` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否系统管理员 1是 0否',
  `is_black` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否黑名单 1是 0否',
...
CREATE TABLE IF NOT EXISTS `votes` (
  ...
  `is_multiple` tinyint NOT NULL DEFAULT 0 COMMENT '是否多选 1多选 0单选',
  `status` tinyint NOT NULL DEFAULT 0 COMMENT '状态',
  `create_time` bigint(13) unsigned NOT NULL DEFAULT 0 COMMENT '创建时间',
  `update_time` bigint(13) unsigned NOT NULL DEFAULT 0 COMMENT '更新时间',
  `is_delete` tinyint(1) unsigned NOT NULL DEFAULT 0,
